...
/**
 * Request DTO for creating a new group with trip planning.
 * Extends group creation to include trip preferences for public pooling.
 */
@Data
public class CreateGroupWithTripRequest {
